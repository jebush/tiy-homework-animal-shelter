...
public class MenuService {
    ...
    //This is the menu callers for entities.Animal Search
    ...
    //This is the menu callers for entities.Animal Manage
    ...
    //This is the menu callers for entities.Animal Type Manage
    ...
    public void displayAnimal(ArrayList<Animal> littleAnimals) throws SQLException {
        ...
        if (littleAnimals.size() == 0){
            ...
            for (int x = 0; x < littleAnimals.size(); x++) {
                ...
                //This displays the entities.Animal data
