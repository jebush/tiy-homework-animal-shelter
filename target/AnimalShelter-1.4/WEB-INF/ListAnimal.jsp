...
<article class="AnimalListing">
    ...
    <div class="AnimalStats">
        <ul class="animalDisplay">
            ...
            <% for (Animal littleanimal : (ArrayList<Animal>) request.getAttribute("animalListByName")) {%>
            <h3><a href=""><%= littleanimal.getName() %></a></h3>
            <li><strong>Type</strong>: <%= littleanimal.getSpecie() %></li>
            <li><strong>Breed</strong>: <%= littleanimal.getBreed() %></li>
            <li><strong>Description</strong>: <%= littleanimal.getDescription() %></li>
